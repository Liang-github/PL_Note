...
- (IBAction)loginButtonPressed:(id)sender {
    ...
    [query findObjectsInBackgroundWithBlock:^(NSArray *array, NSError *error) {
        if (!error) {
            ...
            [AllUtils showPromptDialog:@"提示" andMessage:@"网络异常，请稍后再试！" OKButton:@"确定" OKButtonAction:nil cancelButton:@"" cancelButtonAction:nil contextViewController:self];
        }
    }];
}
